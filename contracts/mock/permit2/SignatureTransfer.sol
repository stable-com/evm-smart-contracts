...
abstract contract SignatureTransfer is ISignatureTransfer, EIP712 {
    ...
    function _permitTransferFrom(
        ...
        SafeERC20.safeTransferFrom(IERC20(permit.permitted.token), owner, transferDetails.to, requestedAmount);
    }
        ...
        unchecked {
            for (uint256 i = 0; i < numPermitted; ++i) {
                ...
                if (requestedAmount != 0) {
                    ...
                    SafeERC20.safeTransferFrom(IERC20(permitted.token), owner, transferDetails[i].to, requestedAmount);
                }
            }
        }
    }
